...
export const EMPTY_ACT = { courage: [], compassion: [] };
export const EMPTY_OATH = { loyalty: [], honor: [] };

export const RESENTMENT_TYPE_DEFAULT = '';
export const RESENTMENT_TYPE_ACKNOWLEDGE = 'RESENTMENT_TYPE_ACKNOWLEDGE';
export const RESENTMENT_TYPE_ANGER = 'RESENTMENT_TYPE_ANGER';
export const RESENTMENT_TYPE_SADNESS = 'RESENTMENT_TYPE_SADNESS'
export const RESENTMENT_TYPE_FEAR = 'RESENTMENT_TYPE_FEAR';
